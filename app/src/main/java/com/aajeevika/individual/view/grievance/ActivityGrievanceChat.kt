...
import com.aajeevika.individual.databinding.ActivityGrievanceChatBinding
import com.aajeevika.individual.utility.Constant
import com.aajeevika.individual.utility.RecyclerViewDecoration
import com.aajeevika.individual.view.grievance.adapter.GrievanceChatRecyclerViewAdapter
...
class ActivityGrievanceChat : BaseActivityVM<ActivityGrievanceChatBinding, GrievanceChatViewModel>(
    ...
    override fun observeData() {
        ...
        viewModel.grievanceLiveData.observe(this, {
            ...
            viewDataBinding.newMessageContainer.visibility =
                if (it.status == 0) View.VISIBLE else View.GONE
            viewDataBinding.ticketClosedMessage.visibility =
                if (it.status == 0) View.GONE else View.VISIBLE
        })
